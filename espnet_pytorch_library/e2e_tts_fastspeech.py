...
from espnet_pytorch_library.fastspeech.duration_calculator import (
    DurationCalculator,  # noqa: H301
)
from espnet_pytorch_library.fastspeech.duration_predictor import DurationPredictor
from espnet_pytorch_library.fastspeech.duration_predictor import (
    DurationPredictorLoss,  # noqa: H301
)
from espnet_pytorch_library.fastspeech.length_regulator import LengthRegulator
...
class FeedForwardTransformer(TTSInterface, torch.nn.Module):
    ...
    def attention_plot_class(self):
        ...
        from espnet_pytorch_library.e2e_tts_transformer import TTSPlot
