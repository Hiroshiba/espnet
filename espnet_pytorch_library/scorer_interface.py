...
class ScorerInterface:
    ...
    Examples:
        * Search heuristics
            * :class:`espnet_pytorch_library.scorers.length_bonus.LengthBonus`
        * Decoder networks of the sequence-to-sequence models
            * :class:`espnet_pytorch_library.nets.transformer.decoder.Decoder`
            * :class:`espnet_pytorch_library.nets.rnn.decoders.Decoder`
        * Neural language models
            * :class:`espnet_pytorch_library.lm.transformer.TransformerLM`
            * :class:`espnet_pytorch_library.lm.default.DefaultRNNLM`
            * :class:`espnet_pytorch_library.lm.seq_rnn.SequentialRNNLM`
...
class PartialScorerInterface(ScorerInterface):
    ...
    Examples:
         * Prefix search for connectionist-temporal-classification models
             * :class:`espnet_pytorch_library.scorers.ctc.CTCPrefixScorer`
